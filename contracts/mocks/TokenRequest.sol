...
contract TokenRequest {
    ...
    event TokenRequestCreated(uint256 requestId, address requesterAddress, address depositToken, uint256 depositAmount, uint256 requestAmount, string referenceString);
    ...
    */
    function initialize(address _vault, address[] memory _acceptedDepositTokens) public {
    ...
    */
    function createTokenRequest(address _depositToken, uint256 _depositAmount, uint256 _requestAmount, string memory _reference)
    external
    payable
    returns (uint256)
    {
        ...
        tokenRequests[tokenRequestId] = TokenRequestData(msg.sender, _depositToken, _depositAmount, _requestAmount, Status.Pending);
    ...
    */
    function refundTokenRequest(uint256 _tokenRequestId) external tokenRequestExists(_tokenRequestId) {
